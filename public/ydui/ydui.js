...
!function (window, ydui) {
     ...
     */
    dialog.alert = function (background,img,mes, callback) {
		...
		if(mes.length==4){
            ...
            '			<div class="zwl-title" style="background-color:'+background+'">提示</div>'+
            '           <div class="alert-zwl"><img class="imgT" src="'+img+'"><div class=" confirm-bd1">' + (mes || 'YDUI Touch') + '</div></div>' +
            '           <div class="confirm-ft">' +
            '               <span class="confirm-btn primary" style="background-color:'+background+'">我知道了</span>' +
            '           </div>' +
            '       </div>' +
            '   </div>' +
            '</div>');
          }else if(mes.length>4 && mes.length<=12){
          	 var $dom = $('' +
            '<div id="' + ID + '">' +
            '   <div class="mask-black-dialog">' +
            '       <div class="m-confirm m-alert">' +
            '			<div class="zwl-title" style="background-color:'+background+'">提示</div>'+
            '           <div class="alert-zwl"><img class="imgT" src="'+img+'"><div class="confirm-bd2">' + (mes || 'YDUI Touch') + '</div></div>' +
            '           <div class="confirm-ft">' +
            '               <span class="confirm-btn primary" style="background-color:'+background+'">我知道了</span>' +
            '           </div>' +
            '       </div>' +
            '   </div>' +
            '</div>');
          }else if(mes.length>12 && mes.length<23){
          	var $dom = $('' +
            '<div id="' + ID + '">' +
            '   <div class="mask-black-dialog">' +
            '       <div class="m-confirm m-alert">' +
            '			<div class="zwl-title" style="background-color:'+background+'">提示</div>'+
            '           <div class="alert-zwl"><img class="imgT" src="'+img+'"><div class="confirm-bd3">' + (mes || 'YDUI Touch') + '</div></div>' +
            '           <div class="confirm-ft">' +
            '               <span class="confirm-btn primary" style="background-color:'+background+'">我知道了</span>' +
            '           </div>' +
            '       </div>' +
            ...
            '       <div class="m-confirm m-alert">' +
            '			<div class="zwl-title" style="background-color:'+background+'">提示</div>'+
            '           <div class="alert-zwl"><img class="imgT" src="'+img+'"><div class="confirm-bd4">' + (mes || 'YDUI Touch') + '</div></div>' +
            '           <div class="confirm-ft">' +
            '               <span class="confirm-btn primary" style="background-color:'+background+'">我知道了</span>' +
            '           </div>' +
            '       </div>' +
